...
class AdvertController extends Controller
{
	...
	public function purgeAction($days, Request $request){
		...
		$nbPurged = $purger->purge($days);
		$request->getSession()->getFlashBag()->add('info', 'Annonces purgées !'.$nbPurged);
		return $this->render('OCPlatformBundle:Advert:purge.html.twig', array('nbPurged' => $nbPurged));
